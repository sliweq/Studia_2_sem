...
public class Cscan {
    ...
    public Cscan(int allRequestsAmount,int allRealTime, ArrayList<Request> allRequests ){
    ...
    public void updateArm(){
        ...
        //     if(req.getPlaceOnDrive() > armPosition){
        //         isNext = true;
        //     }
        // }
        // if(isNext){
    ...
    //update wszystkich procesów które znajdują się na ramieniu gdy dobiliśmy do właściwego kaska
